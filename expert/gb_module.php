...
<button style="margin-left:320px;width:70px;cursor:pointer;" onclick='alerted();' title="Добавьте запись"> Add </button>
...
if ($result) {
	...
	echo "<p style=\"margin-left:250px;\">Total suspicious situations requiring clarification: ".$num_results."</p>";
...
?>
	...
	<tr><td>&nbsp;</td>
		...
		<td>
			...
			<input style="cursor:pointer;" type="submit" value=" Delete " title="Удалите запись" />
			&nbsp;</form>
		</td>
	</tr>
	</table>	
